...
public class UpdateCoursesPositiveTests extends TestBase {
    ...
    @Test(description = "Edit Course Title Positive Test")
    public void editCoursePositiveTest(){

        driver.findElement(By.xpath("//button[text()='My Created Courses']")).click();
        driver.findElement(By.cssSelector(".edit-button")).click();
        driver.findElement(By.cssSelector("#title")).click();
        driver.findElement(By.cssSelector("#title")).clear();
        driver.findElement(By.cssSelector("#title")).sendKeys("Update course Title");
        driver.findElement(By.cssSelector(".edit-course-submit")).click();

        Assert.assertTrue(isElementPresent(By.xpath("//div[contains(text(), 'Course updated successfully')]")));
    }

    @Test(description = "Edit Course Price Positive Test")
    ...
    @Test(description = "Edit Course Description Positive Test")
